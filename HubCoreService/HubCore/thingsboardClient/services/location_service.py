...
# TODO: Add filter pattern and priority sources back
# from ..config import location_filter_pattern, location_priority_sources
from ..tb_utils.constants import Constants

# TODO: Get constants once n2k client is merged and settings util is added
...
class LocationService:
    ...
    #             if os.path.exists(Constants.GEOFENCE_CONFIG_PATH):
    #                 self._logger.info("Using old geofence from file")
    #                 try:
    #                     with open(
    #                         Constants.GEOFENCE_CONFIG_PATH, "r", encoding="utf-8"
    #                     ) as geofence_file:
    ...
    #                 if os.path.exists(Constants.LOCATION_CONSENT_PATH):
    #                     with open(
    #                         Constants.LOCATION_CONSENT_PATH, "r+", encoding="utf-8"
    ...
    #                     with open(
    #                         Constants.LOCATION_CONSENT_PATH, "w", encoding="utf-8"
    #                     ) as location_consent_file:
    ...
    #                             if (
    #                                 data[Constants.IS_ENABLED_KEY]
    #                                 != geofence_is_enabled
    #                             ):
    #                                 geofence_consent_local_file.seek(0)
    #                                 json_data = {
    #                                     Constants.IS_ENABLED_KEY: geofence_is_enabled
    #                                 }
    ...
    #                         with open(
    #                             Constants.GEOFENCE_CONSENT_PATH, "w", encoding="utf-8"
    ...
    #                     Constants.CURRENT_LOCATION_FILE
    #                 ):
    #                     try:
    #                         os.remove(Constants.CURRENT_LOCATION_FILE)
