# https://github.com/thingsboard/thingsboard-gateway/blob/2d85b24e0ab6c0a5232b48f2e83fd71b63eb3286/thingsboard_gateway/tb_utility/tb_remote_shell.py#L1
...
class RemoteShell:
    __logger: logging.Logger = logging.getLogger("RemoteShell")
    __thingsboard_client: ThingsBoardClient = None
    ...
    def __init__(self, thingsboard_client: ThingsBoardClient):
        ...
        self.__thingsboard_client = thingsboard_client
        self.register_rpc_callbacks()

    def register_rpc_callbacks(self):
        self.__thingsboard_client.set_rpc_handler("getTermInfo", self.get_term_info)
        self.__thingsboard_client.set_rpc_handler("sendCommand", self.send_command)
        self.__thingsboard_client.set_rpc_handler("getCommandStatus", self.get_command_status)
        self.__thingsboard_client.set_rpc_handler("terminateCommand", self.terminate_command)
